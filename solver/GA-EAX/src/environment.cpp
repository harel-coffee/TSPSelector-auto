...
void TEnvironment::init(){
	...
	fMaxStagBest = 0;
	fStage = 1;				// �׶�1
	fFlagC[ 0 ] = 4;		// ά����Ⱥ������	1:Greedy, 2:---, 3:Distance, 4:Entropy
	fFlagC[ 1 ] = 1;		// Eset����			1:Single-AB, 2:Block2
} 
...
void TEnvironment::initPop(){
	for ( int i = 0; i < Npop; ++i ){ 
		tKopt->makeRandSol( tCurPop[ i ] );		// ����һ�����·��
		tKopt->doIt( tCurPop[ i ] );			// �ֲ�����(2-opt neighborhood) 
	}
}
...
void TEnvironment::generateKids( int s ){
	// tCurPop[fIndexForMating[s]] ���滻ΪtCross->DoIt()���Ӵ���һ�����Ž�
	// fEdgeFreq[][] ͬʱ������
