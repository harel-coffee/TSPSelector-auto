/*
In this variant LKH will be restarted when during n runs in LKH-heuristic, where n is the
size of the TSP instance to be solved, no improved solution
has been found.
*/
#include "LKH.h"
#include "Genetic.h"

GainType globalbest = -1;
/*
...
int main(int argc, char *argv[])
{
    ...
    if (BestCost <= Optimum && StopAtOptimum)
    {
        printf("ascent has solved this problem\n");
    ...
    Runs = INT_MAX; // runs until time budget exhausted or find optimum
    int no_improve = 0;
