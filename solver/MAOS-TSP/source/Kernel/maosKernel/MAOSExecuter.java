...
import maosKernel.TimeoutSignalHandler;
import sun.misc.*;
...
public final class MAOSExecuter {
  ...
  public static void main(String[] args) {
    TimeoutSignalHandler timeoutSignal = new TimeoutSignalHandler();
    Signal.handle(new Signal("TERM"), timeoutSignal);
    Signal.handle(new Signal("INT"), timeoutSignal);
    try {
